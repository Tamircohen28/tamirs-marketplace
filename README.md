...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Cursor-3.16.29-000000" alt="Cursor 3.16.29" />
...
|--------|---------|-------------------|-----------------|---------------|
| [Claude Code](https://code.claude.com/docs/en/plugin-marketplaces) | 2.0.0 | **2.1.233** | ✅ marketplace | [claude-code.md](docs/user/install/claude-code.md) |
| [Cursor](https://cursor.com/docs/plugins) | 3.16.29 | **3.16.29** | ✅ team marketplace | [cursor.md](docs/user/install/cursor.md) |
