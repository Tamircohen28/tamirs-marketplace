...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Claude%20Code-2.1.281-blueviolet" alt="Claude Code 2.1.281" />
...
|--------|---------|-------------------|-----------------|---------------|
| [Claude Code](https://code.claude.com/docs/en/plugin-marketplaces) | 2.0.0 | **2.1.281** | ✅ marketplace | [claude-code.md](docs/user/install/claude-code.md) |
...
Cursor and OpenCode values above were validated from their CLIs. Claude Code 2.1.281 was
confirmed live on 2026-09-23 — this run's runner has the `claude` CLI installed and
`claude --version` reports `2.1.281 (Claude Code)`, matching the target exactly, covering
the 2.1.280 → 2.1.281 delta on top of the prior 2.1.280 live confirmation (2.1.279 shipped
no changelog entry). Codex 0.153.4 was revalidated on 2026-09-08 against the
