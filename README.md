...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Claude%20Code-2.1.272-blueviolet" alt="Claude Code 2.1.272" />
...
|--------|---------|-------------------|-----------------|---------------|
| [Claude Code](https://code.claude.com/docs/en/plugin-marketplaces) | 2.0.0 | **2.1.272** | ✅ marketplace | [claude-code.md](docs/user/install/claude-code.md) |
...
Cursor and OpenCode values above were validated from their CLIs. Claude Code 2.1.272 was
reviewed on 2026-09-15 against the published changelog (the runner's live `claude --version`
already reads 2.1.273, one release ahead of this target — see the platform-targets doc for
why that isn't treated as live validation of 2.1.272 itself). Codex
