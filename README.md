...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Claude%20Code-2.1.274-blueviolet" alt="Claude Code 2.1.274" />
...
|--------|---------|-------------------|-----------------|---------------|
| [Claude Code](https://code.claude.com/docs/en/plugin-marketplaces) | 2.0.0 | **2.1.274** | ✅ marketplace | [claude-code.md](docs/user/install/claude-code.md) |
...
Cursor and OpenCode values above were validated from their CLIs. Claude Code 2.1.274 was
validated live on 2026-09-17 — the runner's `claude --version` reports `2.1.274 (Claude
