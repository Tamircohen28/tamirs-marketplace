...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Claude%20Code-2.1.223-blueviolet" alt="Claude Code 2.1.223" />
...
|--------|---------|-------------------|-----------------|---------------|
| [Claude Code](https://code.claude.com/docs/en/plugin-marketplaces) | 2.0.0 | **2.1.223** | ✅ marketplace | [claude-code.md](docs/user/install/claude-code.md) |
