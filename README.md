...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Claude%20Code-2.1.246-blueviolet" alt="Claude Code 2.1.246" />
...
|--------|---------|-------------------|-----------------|---------------|
| [Claude Code](https://code.claude.com/docs/en/plugin-marketplaces) | 2.0.0 | **2.1.246** | ✅ marketplace | [claude-code.md](docs/user/install/claude-code.md) |
...
Cursor and OpenCode values above were validated from their CLIs. Claude Code 2.1.246 was
validated on 2026-08-26 directly from `claude --version` on the runner. Codex
