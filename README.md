...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Claude%20Code-2.1.251-blueviolet" alt="Claude Code 2.1.251" />
...
|--------|---------|-------------------|-----------------|---------------|
| [Claude Code](https://code.claude.com/docs/en/plugin-marketplaces) | 2.0.0 | **2.1.251** | ✅ marketplace | [claude-code.md](docs/user/install/claude-code.md) |
...
Cursor and OpenCode values above were validated from their CLIs. Claude Code 2.1.251 was
validated on 2026-08-30 directly from `claude --version` on the runner. Codex
