...
| Cursor | 3.15.19 | 3.15.19 | [install/cursor.md](install/cursor.md) |
...
- Cursor ≥ 3.15.19 (**Cursor → About Cursor**). Cursor documents no minimum for plugins;
  3.15.19 is what this catalog was validated on.
