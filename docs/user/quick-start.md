...
| Cursor | 3.20.17 | 3.20.17 | [install/cursor.md](install/cursor.md) |
...
- Cursor ≥ 3.20.17 (**Cursor → About Cursor**). Cursor documents no minimum for plugins;
  3.20.17 is what this catalog was validated on.
