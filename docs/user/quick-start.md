...
| Cursor | 3.18.9 | 3.18.9 | [install/cursor.md](install/cursor.md) |
...
- Cursor ≥ 3.18.9 (**Cursor → About Cursor**). Cursor documents no minimum for plugins;
  3.18.9 is what this catalog was validated on.
