...
| Cursor | 3.21.13 | 3.21.13 | [install/cursor.md](install/cursor.md) |
...
- Cursor ≥ 3.21.13 (**Cursor → About Cursor**). Cursor documents no minimum for plugins;
  3.21.13 is what this catalog was validated on.
