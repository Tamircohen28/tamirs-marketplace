...
| Cursor | 3.16.29 | 3.16.29 | [install/cursor.md](install/cursor.md) |
...
- Cursor ≥ 3.16.29 (**Cursor → About Cursor**). Cursor documents no minimum for plugins;
  3.16.29 is what this catalog was validated on.
