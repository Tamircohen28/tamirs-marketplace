...
| Cursor | 3.15.6 | 3.15.6 | [install/cursor.md](install/cursor.md) |
...
- Cursor ≥ 3.15.6 (**Cursor → About Cursor**). Cursor documents no minimum for plugins;
  3.15.6 is what this catalog was validated on.
