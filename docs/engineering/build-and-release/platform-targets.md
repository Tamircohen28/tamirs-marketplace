...
revalidated against **3.16.29** on **2026-08-19** (changelog through date-only **2026-08-19**), which is also the most recent
...
- **Cursor `0.45.0`** predates Cursor's plugin system entirely — a 0.x release could never
  ...
  so the floor is now the version this catalog was actually validated on (3.16.29) rather
  than a guess.
